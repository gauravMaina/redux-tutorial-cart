...
function mapDistpatchToProps (dispatch, payload) {
  return {
    remove: () =>
      dispatch({
        type: REMOVE,
    ...
    increase: () => dispatch({ type: INCREASE, payload: { id: payload.id } }),
    decrease: () =>
      dispatch({
        type: DECREASE,
...
export default connect(mapStateToProps, mapDistpatchToProps)(CartItem)
